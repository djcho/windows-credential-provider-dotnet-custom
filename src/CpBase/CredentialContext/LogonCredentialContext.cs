...
{
    public class LogonCredentialContext : CredentialContext
    {
        public LogonCredentialContext(in Guid cpClsid, in _CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus)
            : base(cpClsid, cpus, CREDENTIAL_CONTEXT_SCENARIO.CCS_LOGON)
        {
        }
        ...
        public override void GetSerialization(
            ...
            ref Constants.CredentialProviderConnectResult cpConnectResult, 
            in FieldController fieldController,
