...
{
    public class IdPwLogonCredentialContext : LogonCredentialContext
    {
        public IdPwLogonCredentialContext(in Guid cpClsid, in _CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus) : base(cpClsid, cpus)
        {
            Log.LogMethodCall();
        }
